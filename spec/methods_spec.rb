...
describe Methods do
  ...
  describe '#select_methods' do
    context 'return an array with either class or intance methods' do
      it 'return array with all class methods' do
        object.class_module_list('class', doc.parsed_page)
  ...
  describe '#method_list_for' do
    context 'return a list all class/module methods or a list of instance methods' do
      it 'for all methods' do
        object.class_module_list('class', doc.parsed_page)
        object.search_by_name('array')
        object.create_sub_url(doc)
      ...
      it 'for instance methods' do
        ...
        object.search_by_name('enumerable')
        object.create_sub_url(doc)
        instance = object.method_list_for('instance')
        expect(instance.length).to eql(59)
      end
    end
  end
